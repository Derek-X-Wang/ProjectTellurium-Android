...
public class CognitoHelper {
     ...
     */
    private static final String userPoolId = AWSConfiguration.AMAZON_COGNITO_USER_POOL_ID;

    /**
     * Add you app id
     */
    private static final String clientId = AWSConfiguration.AMAZON_COGNITO_USER_POOL_CLIENT_ID;
     ...
     */
    private static final String clientSecret = AWSConfiguration.AMAZON_COGNITO_USER_POOL_CLIENT_SECRET;
    ...
    public void signUpInBackground(String email, String psd, SignUpHandler handler) {
        String userId = email;
        CognitoUserAttributes userAttributes = new CognitoUserAttributes();
        userAttributes.addAttribute("email", email);
        SignUpHandler signupCallback = handler;

        userPool.signUpInBackground(userId,psd,userAttributes,null,signupCallback);
